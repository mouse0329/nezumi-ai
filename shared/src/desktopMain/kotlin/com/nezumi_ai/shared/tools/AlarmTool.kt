...
actual class AlarmTool actual constructor() : Tool {
    ...
    override val description = "Set or manage alarms (desktop notification)"
    ...
    override suspend fun execute(parameters: Map<String, Any>): ToolResult {
        ...
        return when (action) {
            "set" -> {
                ...
                // TODO: Implement actual desktop alarm using Timer or ScheduledExecutorService
                // For now, just beep
                try {
                ...
                ToolResult(true, "Desktop notification set for $time: $message")
            }
