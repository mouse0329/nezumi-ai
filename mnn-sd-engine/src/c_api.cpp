...
const char* mnn_sd_error_string(MnnSdError code) {
    switch (code) {
        case MNN_SD_OK: return "ok";
        case MNN_SD_ERR_MODEL_NOT_FOUND: return "model_not_found";
        case MNN_SD_ERR_MODEL_INVALID: return "model_invalid";
        case MNN_SD_ERR_NOT_LOADED: return "not_loaded";
        case MNN_SD_ERR_INVALID_PARAMS: return "invalid_params";
        case MNN_SD_ERR_OUT_OF_MEMORY: return "out_of_memory";
        case MNN_SD_ERR_BACKEND_INIT_FAILED: return "backend_init_failed";
        case MNN_SD_ERR_CANCELLED: return "cancelled";
        case MNN_SD_ERR_INTERNAL: return "internal";
...
void mnn_sd_cancel(MnnSdEngine* engine) {
    if (engine) engine->cancel_requested = true;
}
